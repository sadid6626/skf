...
<div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">SK+F</a>
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="#">Engeneering</a>
            ...
            <li class="nav-item">
                <a class="nav-link " href="all.php">All user Details</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="#">Server Instrument</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="#">Ip Phone</a>
            </li>
        </ul>
